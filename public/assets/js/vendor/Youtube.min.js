(function (root, factory) {
    ...
    var Youtube = videojs.extend(Tech, {
        ...
        setMuted: function (mute) {
            ...
            // Fix: removed incorrect this.muted(true) call
            if (mute) {
                this.ytPlayer.mute();
            } else {
    ...
    function injectCss() {
        var css =
            ...
            // Show big play button on mobile YouTube when NOT playing
            ".vjs-youtube-mobile .vjs-big-play-button { display: block !important; }" +
            // Hide big play button when playing or seeking
            ".vjs-youtube-mobile.vjs-playing .vjs-big-play-button { display: none !important; }" +
            ".vjs-youtube-mobile.vjs-seeking .vjs-big-play-button { display: none !important; }";
